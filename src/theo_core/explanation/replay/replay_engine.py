...
class ReplayEngine:
    ...
    def __init__(self, recorder: TraceRecorder, cognitive_engine: CognitiveEngine) -> None:
        """Initialize ReplayEngine.

        Args:
            recorder: TraceRecorder instance to load trace files.
            cognitive_engine: CognitiveEngine instance to execute replay.
    ...
    def replay(self, trace_id: str) -> ReplayResult:
        ...
        replayed_state = self._cognitive_engine.process(trace.raw_input)

...
- LLMs/SLMs act as proposal engines (Hypothesis generation).
- Neural perception via embeddings and tokenizers.
- Strict adherence to Canon laws (neural predictions do not bypass the Decision Engine).

### v0.6: Hybrid Cognition

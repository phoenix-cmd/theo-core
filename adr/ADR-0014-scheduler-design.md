# ADR-0014: Background Job Scheduler
...
THEO requires production-grade architectural guidance for background job scheduler that supports a decade of research and engineering evolution without major rewrites.

# ADR-0006: Project Layout and Package Manager
...
THEO requires production-grade architectural guidance for project layout and package manager that supports a decade of research and engineering evolution without major rewrites.

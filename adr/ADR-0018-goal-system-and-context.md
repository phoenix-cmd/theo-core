# ADR-0018: Goal Management and Active Context
...
THEO requires production-grade architectural guidance for goal management and active context that supports a decade of research and engineering evolution without major rewrites.

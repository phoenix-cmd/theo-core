# ADR-0005: Experiment Tracking Abstraction
...
THEO requires production-grade architectural guidance for experiment tracking abstraction that supports a decade of research and engineering evolution without major rewrites.

# ADR-0008: Event Bus Communication
...
THEO requires production-grade architectural guidance for event bus communication that supports a decade of research and engineering evolution without major rewrites.

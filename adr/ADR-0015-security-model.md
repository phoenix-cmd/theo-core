# ADR-0015: Security and Permissions Model
...
THEO requires production-grade architectural guidance for security and permissions model that supports a decade of research and engineering evolution without major rewrites.

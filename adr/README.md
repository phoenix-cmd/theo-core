...
Every major architectural, research, or system design decision for THEO MUST be documented in an ADR before implementation.

## ADR Index

- [ADR-0001: Multi-Repository Architecture](ADR-0001-repository-architecture.md)
- [ADR-0002: Configuration System](ADR-0002-configuration-system.md)
- [ADR-0003: Dependency Injection Strategy](ADR-0003-dependency-injection.md)
- [ADR-0004: Interface & Versioning Strategy](ADR-0004-interface-strategy.md)
- [ADR-0005: Experiment Tracking](ADR-0005-experiment-tracking.md)
- [ADR-0006: Project Layout & Build System](ADR-0006-project-layout.md)
- [ADR-0007: Cognitive Architecture Stack](ADR-0007-cognitive-architecture-stack.md)
- [ADR-0008: Event Bus Communication](ADR-0008-event-bus.md)
- [ADR-0009: Kernel Design](ADR-0009-kernel-design.md)
- [ADR-0010: Top-Level Memory Architecture](ADR-0010-memory-architecture.md)
- [ADR-0011: Knowledge Subsystem](ADR-0011-knowledge-layer.md)
- [ADR-0012: Plugin SDK Architecture](ADR-0012-plugin-sdk.md)
- [ADR-0013: Unified Artifact Registry](ADR-0013-registry-design.md)
- [ADR-0014: Background Job Scheduler](ADR-0014-scheduler-design.md)
- [ADR-0015: Security & Permissions Model](ADR-0015-security-model.md)
...
See [template.md](template.md) for the standardized record structure.
